...
if __name__ == "__main__":
    ...
    parser.add_argument('--input_dir',nargs='+', default=[r'E:\projectdata\B_bokelin\yibiaozhu\pingshen\20220331_29'],
                        help='dateset absolute path')
    parser.add_argument('--output_dir', type=str, default=r'E:\fitow_project\YOLOV5\yolov5-5.0\data',
